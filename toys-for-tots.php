...
<title>Toys for Tots - Hilton Woodbridge</title>
...
<td height="20" valign="top" class="global_nav_dotted_bg"><a href="your-stay.php" onmouseover="ImageOn('nav_your_stay');" onmouseout="ImageOff('nav_your_stay');"><img name="nav_your_stay" src="images/global_navigation/nav_your_stay.gif" alt="Reservations, Rooms & Suites, Amenities, Local Attractions, Directions" width="66" height="16" border="0"></a><a href="your-event.php" onmouseover="ImageOn('nav_your_event');" onmouseout="ImageOff('nav_your_event');"><img name="nav_your_event" src="images/global_navigation/nav_your_event.gif" alt="Weddings, Private Events, Business Events" width="83" height="16" border="0"></a><a href="dining-entertainment.php" onmouseover="ImageOn('nav_dining_entertainment');" onmouseout="ImageOff('nav_dining_entertainment');"><img name="nav_dining_entertainment" src="images/global_navigation/nav_dining_entertainment.gif" alt="Bogat's Lounge, La Cafe Metro, Romulus, Spats Teak House, Hotel Room Service, Hotel Brunches, Holiday Parties" width="160" height="16" border="0"></a><a href="health-fitness.php" onmouseover="ImageOn('nav_health_fitness');" onmouseout="ImageOff('nav_health_fitness');"><img name="nav_health_fitness" src="images/global_navigation/nav_health_fitness.gif" alt="Facilities, Spa & Massage Therapy, Personal Training, Club Membership" width="119" height="16" border="0"></a><a href="specials.php"><img src="images/global_navigation/nav_specials_off.gif" width="67" height="16" border="0"></a></td>
      ...
      <tr valign="top">
        ...
        <td width="625"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td colspan="3"><a href="specials.php"><img src="images/mchd-specials.jpg" alt="Rooms & Suites" width="625" height="160" border="0"></a></td>
            </tr>
            <tr>
            ...
            <tr>
              <td height="20" colspan="3">                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="370" rowspan="2" valign="top">                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr valign="top">
                            <td class="copy"><span class="copyhead">Toys for Tots</span>
                              <p><strong>Let&rsquo;s join together and make this the best toy drive in the history of the Hotel!</strong></p>
                              <ul>
                                <li>Bring in a new unwrapped toy</li>
                                <li>Place your toy in the toy box located in the Hotel<br>
                                  lobby (by the elevators)</li>
                                <li>The toy box will be available beginning on Friday, November 26, 2010</li>
                              </ul>
                              <p><strong>Deadline for toys will be, Wednesday, December 15, 2010</strong></p>
                              <p>We appreciate your kindness and generosity. Thank you for your continued support through the years.</p>
                              <p><strong>For more information contact Jackie Diverio,  Human Resources, at </strong><strong>(732) 494-6200</strong></p>
                              <!--p><strong>Pricing:</strong></p>
                              <table width="360" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td>Party Package Only</td>
                                  <td><strong>$310.00</strong> Per Couple<br>
                                  (Inclusive of Tax &amp; Gratuity)<br></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                ...
                                <tr>
                                  <td width="125">Overnight Package</td>
                                  <td><strong>$435.00</strong> Per Couple<br>
                                  (Inclusive of Tax &amp; Gratuity)<br></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                ...
                                <tr>
                                  <td width="125">Single Dinner Package</td>
                                  <td><strong>$176.00</strong> Per Person<br>
                                  (Inclusive of Tax &amp; Gratuity)<br></td>
                                </tr>
                              </table>
                              <p><strong>Terms:</strong></p>
                              <ul>
                                <li>Payment must be made in full in advance, cancellations are subject to a  handling fee and no refunds will be given after 12/15/07.</li>
                                <li>Guestroom requests are on an availability basis and can not be guaranteed.</li>
                                <li>Guests must be 21, no children are permitted in the hotel.</li>
                                <li>Proper dress code is required, men must wear a jacket.</li>
                              </ul>
                              <p>To make a reservation, call us at (732) 494-4964. </p>
                              <p class="footnote">Offer valid 12/31/07 only. </p-->
                              <p class="footnote">&nbsp;</p>  </td>
                          </tr>
                      </table> </td>
                      <td width="28" rowspan="2" valign="top">&nbsp;</td>
                      <td width="227" valign="top">
                        <p class="copy"><a href="images/toys-for-tots-hiltonwoodbridge.pdf"><img src="images/toys-for-tots-hiltonwoodbridge.gif" alt="2011 New Year's Eve Party" width="215" height="268" border="0"></a></p>
                        <p class="copy"><strong>Click to download the PDF.</strong> To view  PDFs you might need <a href="http://www.adobe.com/products/acrobat/readstep2.html" target="_blank"> Adobe Acrobat Reader.</a> <br>
                          <br>
                            <a href="http://www.adobe.com/products/acrobat/readstep2.html" target="_blank"><img src="http://www.adobe.com/images/shared/download_buttons/get_adobe_reader.gif" alt="Get Acrobat Reader" name="adobe_reader" width="112" height="33" border="0"></a></p>
                      </td>
                    </tr>
                    <tr>
        ...
        <td width="217" align="left">
          ...
          <br>          <table width="217" border="0" cellpadding="0" cellspacing="0">
            <tr>
