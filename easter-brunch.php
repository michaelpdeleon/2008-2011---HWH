...
<title>Easter Sunday Brunch Special - Hilton Woodbridge</title>
                    ...
                    <tr>
                      <td width="370" rowspan="2" valign="top"><!-- InstanceBeginEditable name="MAINCOPY" -->
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr valign="top">
                            <td class="copy"><span class="copyhead">Join us for Easter  Sunday Brunch 2012 </span>
                              <p><strong>Sunday, April 8, 2012</strong><br>
                              10:30 a.m. - 2:30 p.m. </p>
                              <p>&nbsp;</p>
                              <table width="360" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td width="125">Adults</td>
                                  <td><strong>$29.95</strong></td>
                                </tr>
                                <tr>
                                  <td width="125">Children under 10 </td>
                                  <td><strong>$16.95</strong></td>
                                </tr>
                                <tr>
                                  <td width="125">Children under 3 </td>
                                  <td><strong>FREE</strong></td>
                                </tr>
                              </table>
                              <p><a href="images/Easter-2012.pdf" target="_blank"><img src="images/icon_PDF_small.gif" alt="pdf" width="16" height="16" border="0"> Download  Easter Sunday Brunch Menu </a><span class="footnote">(PDF 97KB)</span></p>
                              <p>For seating and reservation, call us at 732-494-4964.</p>
                              <p class="footnote">Offer valid 04/08/12 only. </p>
                      ...
                      <td width="227" valign="top"><!-- InstanceBeginEditable name="SIDECOPY" -->
                        <p class="copy"><a href="images/Easter-2012.pdf" target="_blank"><img src="images/Easter-2012-thumb.jpg" alt="Easter Sunday Brunch" width="215" height="278" border="0"></a><br /><br />
                        <a href="images/Easter-2012.pdf" target="_blank"><img src="images/icon_PDF_small.gif" alt="Download PDF" width="16" height="16" border="0"> Easter Sunday Brunch Menu </a><span class="footnote">(PDF 97KB)</span></p>
                      <!-- InstanceEndEditable --></td>
                    </tr>
                    <tr>
