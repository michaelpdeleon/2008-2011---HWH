...
<title>Le Caf&eacute; Metro - Hilton Woodbridge Hotel</title>
...
<td height="20" valign="top" class="global_nav_dotted_bg"><a href="your-stay.php" onmouseover="ImageOn('nav_your_stay');" onmouseout="ImageOff('nav_your_stay');"><img name="nav_your_stay" src="images/global_navigation/nav_your_stay.gif" alt="Reservations, Rooms & Suites, Amenities, Local Attractions, Directions" width="66" height="16" border="0"></a><a href="your-event.php" onmouseover="ImageOn('nav_your_event');" onmouseout="ImageOff('nav_your_event');"><img name="nav_your_event" src="images/global_navigation/nav_your_event.gif" alt="Weddings, Private Events, Business Events" width="83" height="16" border="0"></a><a href="dining-entertainment.php"><img src="images/global_navigation/nav_dining_entertainment_of.gif" width="160" height="16" border="0"></a><a href="health-fitness.php" onmouseover="ImageOn('nav_health_fitness');" onmouseout="ImageOff('nav_health_fitness');"><img name="nav_health_fitness" src="images/global_navigation/nav_health_fitness.gif" alt="Facilities, Spa & Massage Therapy, Personal Training, Club Membership" width="119" height="16" border="0"></a><a href="specials.php" onmouseover="ImageOn('nav_specials');" onmouseout="ImageOff('nav_specials');"><img name="nav_specials" src="images/global_navigation/nav_specials.gif" alt="Special Packages, Special Promotions, Special Events" width="67" height="16" border="0"></a></td>
            ...
            <tr>
              <td height="24" valign="top" class="l2nav"><a href="bogarts-lounge.php">Bogart's Lounge</a>&nbsp;&nbsp;&nbsp; <a href="spats-steak-house.php">Spats Steak House</a>&nbsp;&nbsp;&nbsp; <a href="romulus.php">Romulus</a>&nbsp;&nbsp;&nbsp; <a href="le-cafe-metro.php">Le Caf&eacute; Metro</a></td>
              </tr>
        </table>
          <br></td>
        <td width="20">&nbsp;</td>
      ...
      <tr valign="top">
        ...
        <td width="625"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td colspan="3"><img src="images/mchd-lecafemetro2.jpg" alt="Rooms & Suites" width="625" height="160"></td>
            </tr>
            <tr>
              ...
              <td height="20" colspan="3">                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="370" valign="top">                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="52%" valign="top" class="copy"><p class="copyhead">Traditional Favorites Everyday</p>
                              <p>Enjoy traditional favorites in an informal setting overlooking the hotel lobby.</p>
                              <p><strong>Le Cafe Metro is open for:</strong><br>
                                Breakfast<br>
                                Lunch<br>
                              Dinner</p>
                              <p><strong>Hours<br>
                              </strong>Daily 6:00 a.m. &ndash; 11:00 p.m.<br>
                              </p>
                              <p><strong>Telephone<br>
                              </strong>(732) 494-6200 x2235</p>
                              <p><strong>Attire:</strong> Casual</p>
                              <p><strong>Download Our Menu</strong><br>
                              <a href="images/downloads/menu-lecafemetro.pdf"><img src="images/icon_PDF_small.gif" alt="pdf" width="16" height="16" border="0"> Download Le Caf&eacute; Metro Menu (PDF)</a></p>
                              <p>&nbsp;</p>
                              <p>&nbsp;</p>
                              <p>&nbsp;</p></td>
                          </tr>
