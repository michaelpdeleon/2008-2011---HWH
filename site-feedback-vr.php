              ...
              <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="381" valign="top">
					...
					if ($valid) {
					?>
						<span class="copy">Your feedback has been sent.</span>
					<?
					}
					else {
					?>
                      ...
                      <td class="emailnewsletter_lpad"><table width="313" border="0" cellpadding="0" cellspacing="0">
						...
						<table width="372" border="0" cellpadding="3" cellspacing="0">
                            <tr>
                              ...
                              <td width="242"><input name="name" type="text" id="name" style="width: 155px;" value="<?=$_POST['name'];?>"></td>
                            </tr>
                            <tr>
                              <td width="21">&nbsp;</td>
                            ...
                            <tr>
                              ...
                              <td valign="bottom"><textarea name="comments" id="comments" style="height: 50px; width: 215px;"><?=$_POST['comments'];?></textarea></td>
                            </tr>
                            <tr>
                              <td width="21">&nbsp;</td>
