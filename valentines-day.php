...
<title>Valentine's Day Dinner &amp; Menu Special - Hilton Woodbirdge Hotel</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<meta name="Generator" content="">
<meta name="Description" content="Celebrate Valentine's Day in the Hilton Tradition at the Hilton Woodbridge Hotel in Iselin, NJ">
<meta name="Keywords" content="Valentine's Day, Couples, Dinner, Special Menu, Overnight Package, Valentine's Dinner Package">
              ...
              <td height="20" colspan="3">                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="370" rowspan="2" valign="top">                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr valign="top">
                            <td class="copy"><p class="copyhead">Celebrate Valentine's Day in the Hilton Tradition on Saturday, February 11, 2012.</p>
                              <p><strong>Overnight Package Includes</strong></p>
                              <ul>
                                <li>$309 per couple (inclusive of tax &amp; gratuity)</li>
                                <li>Deluxe Guest Room Accomodations with a late checkout of 1 pm.</li>
                                <li>Sunday brunch for two in Le Cafe Metro</li>
                                <li>Free Admission into Bogar'ts Lounge ($10 value pp)</li>
                                <li>Complete Dinner Package</li>
                              </ul>
                              <p><strong>Valentine's Dinner Package Includes</strong></p>
                              <ul>
                                <li>$159 per couple (inclusive of tax &amp; gratuity) </li>
                                <li>Elegant Four Course Dinner</li>
                                <li>Complimentary Glass of Champagne</li>
                                <li>Chef's Specialty Valentine's Dessert</li>
                              </ul>
                              <p><strong>Enjoy Dancing &amp; Live Entertainment in <a href="bogarts-lounge.php">Bogart's Lounge</a></strong></p>
                              <p>To make a reservation, call us at 732-494-4964 from 9 a.m. to 5 p.m.</p>
                              <p class="footnote">Offer valid 02/11/2012</p>
                            <p class="footnote">&nbsp;</p>  </td>
                          </tr>
                      </table> </td>
                      <td width="28" rowspan="2" valign="top">&nbsp;</td>
                      <td width="227" valign="top">
                        <p class="copy"><strong>Download Package Promo</strong></p>
                        <p class="copy"><a href="images/valentines-day-2012.pdf" target="_blank"><img src="images/valentines-day-2012_thumb.jpg" width="215" height="323" border="0"></a><br>
                            <br>
                          <br>
                            <a href="images/valentines-day-2012.pdf" target="_blank"><img src="images/icon_PDF_small.gif" alt="Download PDF" width="16" height="16" border="0"> Valentine's Day Flyer </a><span class="footnote">(PDF 3.0MB)</span></p>
                      </td>
                    </tr>
                    <tr>
