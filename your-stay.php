...
<title>Hilton Woodbridge - Your Stay</title>
...
<td height="20" valign="top" class="global_nav_dotted_bg"><a href="your-stay.php"><img name="nav_your_stay" src="images/global_navigation/nav_your_stay_off.gif" alt="Reservations, Rooms & Suites, Amenities, Local Attractions, Directions" width="66" height="16" border="0"></a><a href="your-event.php" onmouseover="ImageOn('nav_your_event');" onmouseout="ImageOff('nav_your_event');"><img name="nav_your_event" src="images/global_navigation/nav_your_event.gif" alt="Weddings, Private Events, Business Events" width="83" height="16" border="0"></a><a href="dining-entertainment.php" onmouseover="ImageOn('nav_dining_entertainment');" onmouseout="ImageOff('nav_dining_entertainment');"><img name="nav_dining_entertainment" src="images/global_navigation/nav_dining_entertainment.gif" alt="Bogat's Lounge, La Cafe Metro, Romulus, Spats Teak House, Hotel Room Service, Hotel Brunches, Holiday Parties" width="160" height="16" border="0"></a><a href="health-fitness.php" onmouseover="ImageOn('nav_health_fitness');" onmouseout="ImageOff('nav_health_fitness');"><img name="nav_health_fitness" src="images/global_navigation/nav_health_fitness.gif" alt="Facilities, Spa & Massage Therapy, Personal Training, Club Membership" width="119" height="16" border="0"></a><a href="specials.php" onmouseover="ImageOn('nav_specials');" onmouseout="ImageOff('nav_specials');"><img name="nav_specials" src="images/global_navigation/nav_specials.gif" alt="Special Packages, Special Promotions, Special Events" width="67" height="16" border="0"></a></td>
      ...
      <tr valign="top">
        ...
        <td width="625"><table width="625" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="625" colspan="3"><img src="images/mchd-yourstay.jpg" alt="Your Stay.  Make yourself at home in one of our well-appointed rooms or suites." width="625" height="160"></td>
            </tr>
            <tr>
                    ...
                    <tr>
                      <td width="61%" valign="top">
                        <table border="0" cellspacing="0" cellpadding="0">
                          <tr valign="top">
                            <td height="83"><a href="our-hotel.php"><img src="images/thmb-ourhotel.jpg" alt="Our Hotel" width="123" height="72" border="0"></a></td>
                            <td colspan="2" class="copy"><a href="our-hotel.php"><span class="copyhead">Our Hotel</span></a><br>
                            Explore our hotel and its many exciting amenities. <a href="our-hotel.php"><br>
  &raquo; Explore our amenities</a></div></td>
                          </tr>
                        </table>
                        <br>
                        <br>
                        <table border="0" cellspacing="0" cellpadding="0">
                          <tr valign="top">
                            <td height="83"><a href="rooms-suites.php"><img src="images/thmb-rooms-suites.jpg" alt="Rooms & Suites" width="123" height="72" border="0"></a></td>
                            <td colspan="2" class="copy"><a href="rooms-suites.php"><span class="copyhead">Rooms &amp; Suites</span></a><br>
                              Our spacious rooms are a perfect fit for work or leisure.<a href="rooms-suites.php"><br>&raquo; See our rooms &amp; suites</a>
                            </td>
                          </tr>
                        </table>
                        <br>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                          <tr valign="top">
                            <td height="83"><a href="area-attractions.php"><img src="images/thmb-areaattractions.jpg" alt="Area Attractions" width="123" height="72" border="0"></a></td>
                            <td colspan="2" class="copy"><a href="area-attractions.php"><strong class="copyhead">Area Attractions</strong></a><br>
                              Our central location provides easy access to nearby cities and business centers.<a href="area-attractions.php"><br>
                              &raquo; See what&rsquo;s nearby</a>
                            </td>
                          </tr>
                          
                      </table></td>
                      <td width="3%">&nbsp;</td>
                      <td width="36%" align="right" valign="top">                        <table width="227" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td><img src="images/landing/directions.jpg" alt="Directions" width="227" height="28"></td>
                          </tr>
                          <tr>
                            <td align="left" class="sidebar_text">Getting here is easy.<br>
                                <a href="http://maps.google.com/maps?q=120+Wood+Ave+S,+Woodbridge,+NJ&spn=0.033141,0.057322&hl=en" target="_blank">&raquo;  Map<br>
                            </a><a href="directions.php">&raquo; Driving Directions </a></td>
                          </tr>
                          <tr>
                            <td height="30" align="left" class="floorplans">&nbsp;</td>
                          </tr>
                          <tr>
                            <td><img src="images/landing/transportation.jpg" alt="Transportation" width="227" height="24"></td>
                          </tr>
                          <tr>
                            <td align="left" class="sidebar_text">Free Shuttle Service<br>
                            Our shuttle is available  to our guests within a 3 mile radius of the hotel including Metro Park train station. Just call ahead at (732) 494-6200 and we&rsquo;ll pick you up.</td>
                          </tr>
                      </table> </td>
                    </tr>
                                </table></td>
        ...
        <td width="217" align="left">
          ...
          <? include("includes/phototour_prettyphoto_hotel.php") ?>
          </td>
        <td width="20">&nbsp;</td>
      </tr>
      <tr>
